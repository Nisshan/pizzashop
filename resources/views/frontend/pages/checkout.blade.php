...
<section class="container-lg">
    ...
    <div class="alert alert-primary alert-dismissible fade show border-0 border-3 border-start border-danger position-fixed bottom-0 end-0"
            ...
            <form action="#" id="payment_form">
                ...
                <div class="row g-2">
                    <div class="col-12 col-md mb-3">
                        ...
                        <input type="email" class="form-control" id="city" placeholder="Address">
                    </div>
                    <div class="col-12 col-md mb-3">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-12 col-md mb-3">
                        ...
                        <input type="text" class="form-control" id="phone" placeholder="Province">
                    </div>
                </div>
                ...
                <div class="col-12 text-center mb-4 order-box">
                    <div class="d-flex">
                        <button type="submit" form="payment_form"
                ...
                <div class="">
                    ...
                    <div class="d-flex border-dark border-bottom pb-2 mb-2 align-items-center">
                        <div class="d-flex flex-grow-1">
                            <figure class="mb-0">
                                <img class="img-60 obj-fit-cover" src="https://picsum.photos/600/600">
                            </figure>
                            <div class="ms-2">
                                <h5>Pizza</h5>
                                <span>$ 100</span>
                        ...
                        <div class="">
                            <span class="bg-light p-2 border">1</span>
                        </div>
                    </div>
                    <div class="d-flex border-dark border-bottom pb-2 mb-2 align-items-center">
                        <div class="d-flex flex-grow-1">
