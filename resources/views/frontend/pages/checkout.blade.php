...
<section class="container-lg">
    ...
    <div class="row">
        <div class="col-12 col-md-8 pb-3 mb-md-0 pb-md-0">
            <!-- Contact Details -->
            <div class="form-group row border-bottom pb-4 mb-3 mt-2">
...
<div class="col-8 text-center mb-4 order-box">
    <div class="d-flex">
        <div class="d-block d-md-none text-start col-5">
            <p class="text-muted mb-0 font-1 fw-bold">SUBTOTAL</p>
            <p class="mb-0 fw-bold font-large"> {{$transaction['Payable']}}</p>
        </div>
