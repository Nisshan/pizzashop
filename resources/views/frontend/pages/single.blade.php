...
<div class="alert alert-primary alert-dismissible fade show border-0 border-3 border-start border-primary position-fixed bottom-0 end-0"
    role="alert">
    {{ session()->get('success') }}
    ...
    <div class="row">
        ...
        <div class="col-lg-7">
            ...
            <h2 class="mb-3 fw-light">
                <span class="discount-price me-3" id="price">$ {{$product->price}}</span>
