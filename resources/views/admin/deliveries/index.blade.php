...
@section('title', $title ?? 'Deliveries')
        ...
        <div class="card-header card-primary">
            <div class="row">
                <div class="col-sm-11 card-title">
                    <h5 class="m-0 text-dark">{{ $title ?? 'Deliveries'}}</h5>
                </div>
                <div class="col-sm-1 float-sm-right">
                        <span class="breadcrumb-item float-sm-right"><a href="{{route('deliveries.create')}}"><button
